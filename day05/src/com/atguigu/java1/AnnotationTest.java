 ...
 * **********出现的频率较低*******************
 *
 * @Documented:表示所修饰的注解在被javadoc解析时，保留下来。 Inherited:被他所修饰的Annotation将具有继承性。
 * <p>
 * 5.通过反射获得注解信息
 * <p>
...
class Student extends Person implements Person.Info {
